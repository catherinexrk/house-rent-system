...
public class ShowRoomMessageFrame extends Frame{
	
	public ShowRoomMessageFrame(Tenant tenant) throws SQLException {
		init(tenant);
	}
	
	ShowRoomMessageFrame(int Id) throws SQLException {
		init(Id);
	}
	...
	void init(Tenant tenant) throws SQLException {
        ...
        Room room = new Room();
		room = rm.FindRoomAsID(tenant.getRoom());
		...
		Icon i = new ImageIcon("C:\\Users\\Lenovo\\eclipse-workspace\\RentingSystem\\src\\renting\\imgs\\18.jpg");
